...
for (let i = 0; i < watchicon.length; i++) {
  watchicon[i].addEventListener("click", () => {
    watchbox.style.transform = "translate(26rem, -60rem)";
    blurDiv.style.display = "block";
  });
}
for (let i = 0; i < editicon.length; i++) {
  editicon[i].addEventListener("click", () => {
    editbox.style.transform = "translate(26rem, -60rem)";
    blurDiv.style.display = "block";
  });
}
...
closeWatch.addEventListener("click", () => {
  watchbox.style.transform = "translate(26rem, -147rem)";
...
closeedit.addEventListener("click", () => {
  editbox.style.transform = "translate(26rem, -147rem)";
  blurDiv.style.display = "none";
});
