  ...
  <body>
    <!-- when user click on crud icon then this blurdiv showing in background -->
    <div id="blurDiv"></div>
    ...
    <header data-aos="fade-down">
      <!-- icon -->
      <div id="icon">
        <img src="./icons/charnet1-01 1.png" alt="logo here" />
      </div>
    ...
    <div class="div">
      ...
      <!-- main content -->
      <main class="main" data-aos="fade-left" id="main">
        <!-- wrapper -->
        <div class="wrapper">
          <!-- top content -->
          ...
          while ($amenity = mysqli_fetch_assoc($result)) {
            ...
            <td><center><img src="data:image/gif;base64, ' . $amenity['amenity_image'] . '"  width="70" height="50" /></center></td>
...
//     <?php
// $conn = mysqli_connect('localhost','root','','charnet');
// $rt = "SELECT * FROM `amenity`";
//           $result = mysqli_query($conn, $rt);
...
// $amenity_image=$_POST['amenity_image'];
//  mysqli_query($conn,"update amenity set amenity_name ='".$POST['amenity_name']."',amenity_description='".$POST['amenity_description']."', amenity_image='".$POST['amenity_image']."'
//  where amenity_id='$amenity_id'");
// header('location:amenities.php');
// }
// ?>}
</script>
    <section id="watchbox" class="amenitiesRead">
      <svg
        id="closewatch"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
      ...
      <form class="watchDataForm m-auto mt-16 w-2/3">
        <div class="name flex">
          <label for="nameWatch">Name:</label>
          <input
            type="text"
            value="Air"
            id="nameWatch"
        ...
        <div class="image flex">
          <label for="imageWatch">Image:</label>
          <input
            type="text"
            id="imageWatch"
            value="air.png"
        ...
        <div class="flex mt-10">
          <textarea
            ...
            rows="10"
            id="desc"
            placeholder="Description showing here"
            disabled
          >
Lorem ipsum dolor sit amet consectetur adipisicing.</textarea
          >
        </div>
       ...
       <!--edit portion-->
    <section id="editbox" class="amenitiesEdit">
      <svg
        id="closeedit"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
      ...
      <form
        ...
        id="myForm"
        action="amenities.php"
        onsubmit="return validate()"
      >
        <div class="name flex">
          <label for="nameWatch1">Name:</label>
          <input
            type="text"
            value="Air"
            id="nameWatch1"
            class="border ametiLable"
          />
        </div>

        <div class="image flex">
          <label for="imageWatch1">Image:</label>
          <input type="file" accept="image/*" id="imageWatch1" />
        </div>

        <div class="desc flex mt-10">
          <textarea
            id="descc"
            cols="75"
            rows="10"
        ...
        <button id="submit" type="submit"  onclick="UpdateRecord()" >submit</button>
      </form>
    </section>
    ...
    <form
        ...
        a href="delete.php?amenity_name=<?php echo $amenity["amenity_name"];?>">
        
    <section id="deletebox" class="amenitiesDelete">
      <svg
        id="closedelete"
        xmlns="http://www.w3.org/2000/svg"
        height="24px"
    ...
    <script src="./js/amenitiesClick.js"></script>
    <!-- <script src="./js/editdeletewatch.js"></script> -->
    <script src="./js/script.js"></script>
    <script src="./js/validateForms.js/amenitiesValid.js"></script>
  </body>
</php>
?>
